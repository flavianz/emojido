...
<br/>
To run EmojiDo, you can either clone the compiler from the [GitHub Repo](https://github.com/flavianz/emojido) and run the compiler locally with Node.js, or you can run your code online in the [online executor](/#/run).
<br/>
